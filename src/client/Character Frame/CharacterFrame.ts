...
// import { TCharacterFrame } from "shared/Character Frame/CharacterFrame";
// import { EEpicUIAttributes } from "shared/_References/EpicUIAttributes";
// import { TProgressBar } from "shared/Character Frame/TProgressBar";
...
// 		// Resource Bars
// 		CharacterFrame._healthBar = CharacterFrame._frameTemplate.FindFirstChild("Health Bar", true) as TProgressBar;
...
// 	public static UpdateResourceBar(resourceId: ResourceId, current: number, max: number) {
// 		this._assertUIElements();
// 		switch (resourceId) {
// 			case "Health":
// 				this._updateResourceBar("Health", this._healthBar, current, max);
// 				break;
// 			case "Mana":
// 				this._updateResourceBar("Mana", this._manaBar, current, max);
// 				break;
// 			case "Stamina":
// 				this._updateResourceBar("Stamina", this._staminaBar, current, max);
// 				break;
// 			default:
// 				Logger.Log(script, "Invalid ResourceId: ", resourceId);
// 		}
// 	}

// 	private static _updateResourceBar(text: string, bar: Frame, current: number, max?: number) {
// 		if (max === undefined) {
// 			max = current / (bar.GetAttribute(EEpicUIAttributes.BarPercent) as number);
// 		}
