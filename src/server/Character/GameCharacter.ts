...
// 	private _remoteGameCharacterCreated = Remotes.Server.GetNamespace("PlayerCharacter").Get(
// 		RemoteNames.PlayerCharacterCreated,
// 	);
// 	private _remoteGameCharacterDestroyed = Remotes.Server.GetNamespace("PlayerCharacter").Get(
